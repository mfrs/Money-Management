...
import { exportAnalyticsReport, exportWalletJournal, exportJournalDetail } from '../lib/pdfExport';
import { exportWalletJournalToCSV } from '../lib/excelExport';

export default function ReportsView() {
  const { journals, categories, wallets, totalBalance, totalIncome, totalExpenses, getCategorySpent, addToast, t, language, user } = useApp();
  ...
  const journalEntries = useMemo(() => {
    ...
    return filtered;
  }, [mappedTransactions, selectedWalletId, activeTab, wallets, journalSortOrder, journalStartDate, journalEndDate]);
