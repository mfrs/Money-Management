            ...
            <div className="flex items-center gap-2 bg-on-surface/5 px-3 py-1.5 rounded-full border border-on-surface/5 shadow-sm relative">
              ...
              {isPickerOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-full mt-2 w-64 bg-surface-dim/95  border border-on-surface/10 rounded-[20px] p-4 shadow-2xl z-50 animate-in fade-in slide-in-from-top-2 duration-200">
